...
namespace Baihua.Data.Migrations.Family
{
    ...
    [Migration("20260818163619_AddBenchmarkSessionsToFamily")]
    partial class AddBenchmarkSessionsToFamily
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Baihua.Data.Entities.CheckinMakeupRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("CheckinMakeupRecords");
                });
            ...
            modelBuilder.Entity("Baihua.Data.Entities.FamilyReward", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Baihua.Data.Entities.RewardClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Baihua.Data.Entities.ServerMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("PeerServerId")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("PeerServerId", "SentAtUtc");

                    b.ToTable("ServerMessages", (string)null);
                });

            modelBuilder.Entity("Baihua.Data.Entities.ServerPeer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("ServerPeers", (string)null);
                });
            ...
            modelBuilder.Entity("Baihua.Data.Entities.TodoGoal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("TodoGoals", (string)null);
                });

            modelBuilder.Entity("Baihua.Data.Entities.TodoItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Baihua.Data.Entities.TodoItem", b =>
                {
                    b.HasOne("Baihua.Data.Entities.TodoGoal", "Goal")
                        .WithMany("Items")
